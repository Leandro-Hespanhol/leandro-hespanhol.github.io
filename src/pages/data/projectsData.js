...
export const reactProjects = [
  ...
  },
  {
    ...
    description: 'Have you heard about a witchcraft called Redux? This is what it looks like! While concentrating the props on a Store, I had to use reducers and actions handle those props, all of it working with dispatches, mapDispatchToProps, mapStateToProps.',
    descricao: 'Já ouviu falar de uma bruxaria chamada Redux? É com isso aqui que ela se parece! Concentrando as props em uma Store, eu usei reducers e actions para manipular essas props, tudo isso trabalhando com dispatches, mapDispatchToProps, mapStateToProps.',
